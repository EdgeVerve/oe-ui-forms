 ...
 *    @description Default form template with save functionalities
 *    @modelRequired true   
 */
 ...
 * @polymer
 */
class defaultForm extends OEFormMessagesMixin(OEModelHandler(OEFormValidationMixin(PolymerElement))) {
    static get template() {
        return html`
...
window.customElements.metadefine(defaultForm.is, defaultForm);

export const defaultFormClass = defaultForm;